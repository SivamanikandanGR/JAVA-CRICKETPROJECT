...
public class PlayerServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(page.equals("player"))
		{
			...
			System.out.println(name+" "+nickname+" "+age+" "+birthplace+" "+role+" "+battingstyle+" "+bowlingstyle+" "+wicketkeeper+" "+rating);
			...
			output=playerdao.generateid(name);
			playerbean.setpid(output);
		...
		else if(page.equalsIgnoreCase("delete"))
		{
			 System.out.println("delete");
				String mnumber=request.getParameter("name");
				result=playerdao.delete(mnumber);
				if(result.equalsIgnoreCase("success"))	
				   {
					out.println("<script type=\"text/javascript\">");
